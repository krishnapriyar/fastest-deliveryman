...
public class ScheduledOrderFrame extends javax.swing.JFrame {

    public ScheduledOrderFrame() {
        initComponents();
        comboBoxSetup();
    ...
    private void comboBoxSetup()
    {
        ...
        jCbampm.removeAllItems();
        jCbLocation.removeAllItems();

        
        for(int i=0;i<11;i++)
        {
           jCbHour.addItem(String.valueOf(i + 1));
        }
        
        for(int i=0;i<59;i++)
        {
            jCbMinutes.addItem(String.valueOf(i + 1));
        }
        
        jCbampm.addItem("am");
        jCbampm.addItem("pm");
        
        jCbLocation.addItem("-- Select Location --");
        jCbLocation.addItem("Kuala Lumpur");
        jCbLocation.addItem("Ipoh");
        jCbLocation.addItem("Melaka");
        jCbLocation.addItem("Seremban");
        jCbLocation.addItem("Petaling Jaya");
    }
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jCbHour, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jCbMinutes, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jCbampm, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jCbampm, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScheduledOrderFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScheduledOrderFrame().setVisible(true);
            }
        }); 
    }
    ...
    private static javax.swing.JComboBox<String> jCbHour;
    private javax.swing.JComboBox<String> jCbLocation;
    private static javax.swing.JComboBox<String> jCbMinutes;
    private javax.swing.JComboBox<String> jCbRestaurant;
    private static javax.swing.JComboBox<String> jCbampm;
